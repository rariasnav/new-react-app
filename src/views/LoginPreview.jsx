        ...
        <div className="container">
            <div className="body text-center m-5">
                <div className="d-grid gap-2 m-auto" style={{width: "26rem"}}>
                    ...
                    <p className="text-secondary-custom">If you already have an account Login otherwise Signup</p>
                    <button className="btn btn-primary mb-3" type="button" onClick={ ()=> navigate('/signUp') }>Sign up</button>
